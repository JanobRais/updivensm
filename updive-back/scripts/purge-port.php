...
/**
 * UpdiveNSM CLI utility to purge old ports.
 *
 * @author Maximilian Wilhelm <max@sdn.clinic>
 * @copyright 2016-2017 UpdiveNSM, Barbarossa
 * @license GPL
 */
...
if (! $port_id && ! $port_id_file || ($port_id && $port_id_file)) {
    echo $console_color->convert(\App\Facades\UpdiveNSMConfig::get('project_name') . ' Port purge tool
