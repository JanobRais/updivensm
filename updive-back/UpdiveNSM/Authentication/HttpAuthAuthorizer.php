...
class HttpAuthAuthorizer extends MysqlAuthorizer
{
    ...
    public function userExists($username, $throw_exception = false)
    {
        ...
        if (UpdiveNSMConfig::get('http_auth_guest') && parent::userExists(UpdiveNSMConfig::get('http_auth_guest'))) {
            return true;
        }
    ...
    public function getUserid($username)
    {
        ...
        if (UpdiveNSMConfig::get('http_auth_guest')) {
            return parent::getUserid(UpdiveNSMConfig::get('http_auth_guest'));
        }
