...
class ADAuthorizationAuthorizer extends MysqlAuthorizer
{
    ...
    public function __construct()
    {
        ...
        if (UpdiveNSMConfig::has('auth_ad_check_certificates') &&
            UpdiveNSMConfig::get('auth_ad_check_certificates') == 0) {
        ...
        if (UpdiveNSMConfig::has('auth_ad_binduser') && UpdiveNSMConfig::has('auth_ad_bindpassword')) {
            ...
            if (! ldap_bind($this->ldap_connection, UpdiveNSMConfig::get('auth_ad_binduser') . '@' . UpdiveNSMConfig::get('auth_ad_domain'), UpdiveNSMConfig::get('auth_ad_bindpassword'))) {
    ...
    public function authenticate($credentials)
    {
        ...
        if (UpdiveNSMConfig::get('http_auth_guest')) {
            return true;
        }
    ...
    public function getRoles(string $username): array|false
    {
        ...
        // collect all roles
        $auth_ad_groups = UpdiveNSMConfig::get('auth_ad_groups');
