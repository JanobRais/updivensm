...
class TwoFactor
{
    ...
    {
        $title = 'UpdiveNSM:' . urlencode($username);

        return $counter ?
            "otpauth://hotp/$title?issuer=UpdiveNSM&counter=1&secret=$key" : // counter based
            "otpauth://totp/$title?issuer=UpdiveNSM&secret=$key"; // time based
    }
}
