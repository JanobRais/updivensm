...
use UpdiveNSM\Interfaces\Discovery\DiscoveryModule;
use UpdiveNSM\Interfaces\Polling\PollerModule;
...
class Processor extends Model implements DiscoveryModule, PollerModule, DiscoveryItem
{
    ...
    public static function discover(
        ...
        $proc->processor_perc_warn = $warn_percent ?? UpdiveNSMConfig::get('processor_perc_warn', 75);
