...
trait SyncsModels
{
     ...
     * Model must implement \UpdiveNSM\Interfaces\Models\Keyable interface
     *
     * @param  \Illuminate\Database\Eloquent\Model  $parentModel
     * @param  string  $relationship
     * @param  \Illuminate\Support\Collection<Keyable>  $models  \UpdiveNSM\Interfaces\Models\Keyable
     * @return Collection
     */
     ...
     *
     * @param  Collection  $existing  \UpdiveNSM\Interfaces\Models\Keyable
     * @param  Collection  $discovered  \UpdiveNSM\Interfaces\Models\Keyable
     * @return Collection
     */
