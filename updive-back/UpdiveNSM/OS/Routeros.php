...
use UpdiveNSM\Interfaces\Discovery\Sensors\WirelessCcqDiscovery;
use UpdiveNSM\Interfaces\Discovery\Sensors\WirelessClientsDiscovery;
use UpdiveNSM\Interfaces\Discovery\Sensors\WirelessDistanceDiscovery;
...
use UpdiveNSM\Interfaces\Discovery\Sensors\WirelessQualityDiscovery;
use UpdiveNSM\Interfaces\Discovery\Sensors\WirelessRateDiscovery;
use UpdiveNSM\Interfaces\Discovery\Sensors\WirelessRsrpDiscovery;
use UpdiveNSM\Interfaces\Discovery\Sensors\WirelessRsrqDiscovery;
use UpdiveNSM\Interfaces\Discovery\Sensors\WirelessRssiDiscovery;
use UpdiveNSM\Interfaces\Discovery\Sensors\WirelessSinrDiscovery;
        ...
        $qos->each(function (Qos $thisQos, int $key) use ($poll_time, $treeNames, $treeBytes, $treeDrops, $simpleNames, $simpleBytesIn, $simpleBytesOut, $simpleDropsIn, $simpleDropsOut): void {
            switch ($thisQos->type) {
                ...
                case 'routeros_simple':
                    ...
                    break;
                default:
                    echo 'Queue type ' . $thisQos->type . " has not been implmeneted in UpdiveNSM/OS/Routeros.php\n";
            }
        });
    }
