...
use UpdiveNSM\Discovery\Yaml\IndexField;
use UpdiveNSM\Discovery\Yaml\LiteralField;
use UpdiveNSM\Discovery\Yaml\OidField;
use UpdiveNSM\Discovery\Yaml\YamlDiscoveryField;
use UpdiveNSM\Discovery\YamlDiscoveryDefinition;
...
trait YamlStorageDiscovery
{
    ...
    public function discoverYamlStorage(): Collection
    {
        $discovery = YamlDiscoveryDefinition::make(Storage::class)
            ...
            ->addField(new YamlDiscoveryField('warn_percent', 'storage_perc_warn', \UpdiveNSMConfig::get('storage_perc_warn', 80)))
