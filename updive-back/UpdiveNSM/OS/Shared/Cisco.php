...
use UpdiveNSM\Interfaces\Discovery\MacAccountingDiscovery;
...
use UpdiveNSM\Interfaces\Discovery\QosDiscovery;
use UpdiveNSM\Interfaces\Discovery\SlaDiscovery;
...
use UpdiveNSM\Interfaces\Polling\MacAccountingPolling;
use UpdiveNSM\Interfaces\Polling\NacPolling;
use UpdiveNSM\Interfaces\Polling\QosPolling;
use UpdiveNSM\Interfaces\Polling\SlaPolling;
use UpdiveNSM\OS;
    ...
    VlanPortDiscovery
{
    ...
    public function pollQos($qos)
    {
        ...
        foreach ($qos as $thisQos) {
            ...
            if ($thisQos->type == 'cisco_cbqos_classmap') {
                ...
                d_echo('Cisco CBQoS ' . $thisQos->type . ' not implemented in UpdiveNSM/OS/Shared/Cisco.php');
            }
        }
    }
    ...
    public function discoverVlans(): Collection
    {
        ...
        $current_domain = 0;
        $os = $this->getName();
        $ignore_vlans = (array) UpdiveNSMConfig::getOsSetting($os, 'ignore_vlans');
