    ...
    WirelessSnrDiscovery
{
    ...
    /**
     * Retrieve (and explode to array) list of network interfaces, and desired display name in UpdiveNSM.
     ...
     * type - string, matching to UpdiveNSM documentation => https://docs.UpdiveNSM.org/Developing/os/Wireless-Sensors/
    ...
    {
        // Initialize needed variables, and get interfaces (actual network name, and UpdiveNSM name)
        $sensors = [];
