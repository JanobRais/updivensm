...
use UpdiveNSM\Device\YamlDiscovery;
use UpdiveNSM\Interfaces\Discovery\EntityPhysicalDiscovery;
...
use UpdiveNSM\Interfaces\Discovery\StorageDiscovery;
use UpdiveNSM\Interfaces\Discovery\StpInstanceDiscovery;
use UpdiveNSM\Interfaces\Discovery\StpPortDiscovery;
use UpdiveNSM\Interfaces\Discovery\VlanDiscovery;
use UpdiveNSM\Interfaces\Discovery\VlanPortDiscovery;
use UpdiveNSM\Interfaces\Polling\Netstats\IcmpNetstatsPolling;
use UpdiveNSM\Interfaces\Polling\Netstats\IpForwardNetstatsPolling;
use UpdiveNSM\Interfaces\Polling\Netstats\IpNetstatsPolling;
use UpdiveNSM\Interfaces\Polling\Netstats\SnmpNetstatsPolling;
use UpdiveNSM\Interfaces\Polling\Netstats\TcpNetstatsPolling;
use UpdiveNSM\Interfaces\Polling\Netstats\UdpNetstatsPolling;
use UpdiveNSM\Interfaces\Polling\StpInstancePolling;
use UpdiveNSM\Interfaces\Polling\StpPortPolling;
use UpdiveNSM\OS\Generic;
use UpdiveNSM\OS\Traits\BridgeMib;
use UpdiveNSM\OS\Traits\EntityMib;
use UpdiveNSM\OS\Traits\HostResources;
use UpdiveNSM\OS\Traits\NetstatsPolling;
use UpdiveNSM\OS\Traits\QBridgeMib;
use UpdiveNSM\OS\Traits\UcdResources;
use UpdiveNSM\OS\Traits\YamlMempoolsDiscovery;
use UpdiveNSM\OS\Traits\YamlOSDiscovery;
use UpdiveNSM\OS\Traits\YamlStorageDiscovery;
    ...
    VlanPortDiscovery
{
    ...
    public static function make(array &$device): OS
    {
        if (isset($device['os'])) {
            ...
            $class = StringHelpers::toClass($device['os'], 'UpdiveNSM\\OS\\');
            ...
            if ($os_group = UpdiveNSMConfig::get("os.{$device['os']}.group")) {
                $class = StringHelpers::toClass($os_group, 'UpdiveNSM\\OS\\Shared\\');
