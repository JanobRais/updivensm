...
use UpdiveNSM\Services as ServicesHelper;
use SnmpQuery;
...
class Services implements Module
{
    ...
    public function shouldDiscover(OS $os, ModuleStatus $status): bool
    {
        ...
        return UpdiveNSMConfig::get('discover_services_templates')
            || (UpdiveNSMConfig::get('discover_services') && $device->type === 'server');
    }
    ...
    public function discover(OS $os): void
    {
        ...
        if (UpdiveNSMConfig::get('discover_services_templates')) {
            (new ServiceTemplateController())->applyDeviceAll($device['device_id']);
        }

        if (! UpdiveNSMConfig::get('discover_services')) {
            return;
        }
     ...
     * @inheritDoc
     */
    public function poll(OS $os, \UpdiveNSM\Interfaces\Data\DataStorageInterface $datastore): void
    {
        // no polling
    }
