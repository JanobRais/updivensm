...
class Wireless implements Module
{
    ...
    {
        $submodules = UpdiveNSMConfig::get('discovery_submodules.wireless', WirelessSensorType::values());
        ...
        foreach ($types as $type) {
            ...
            $sensors = collect($sensors)->map(function (\UpdiveNSM\Device\WirelessSensor $legacy) {
    ...
    public function poll(OS $os, DataStorageInterface $datastore): void
    {
        ...
        $submodules = UpdiveNSMConfig::get('poller_submodules.wireless', []);
    ...
    {
        return StringHelpers::toClass("wireless $type discovery", 'UpdiveNSM\\Interfaces\\Discovery\\Sensors\\');
    }
    ...
    {
        return StringHelpers::toClass("wireless $type polling", 'UpdiveNSM\\Interfaces\\Polling\\Sensors\\');
    }
