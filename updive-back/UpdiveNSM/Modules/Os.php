...
class Os implements Module
{
    ...
    public function shouldDiscover(\UpdiveNSM\OS $os, ModuleStatus $status): bool
    {
        return $status->isEnabledAndDeviceUp($os->getDevice());
    }

    public function discover(\UpdiveNSM\OS $os): void
    {
    ...
    public function shouldPoll(\UpdiveNSM\OS $os, ModuleStatus $status): bool
    {
        return $status->isEnabledAndDeviceUp($os->getDevice());
    }

    public function poll(\UpdiveNSM\OS $os, DataStorageInterface $datastore): void
    {
    ...
    private function handleChanges(\UpdiveNSM\OS $os): void
    {
        $device = $os->getDevice();
    ...
    private function updateLocation(\UpdiveNSM\OS $os): void
    {
        $device = $os->getDevice();
    ...
    private function sysContact(\UpdiveNSM\OS $os): void
    {
        $device = $os->getDevice();
