...
use UpdiveNSM\Interfaces\Discovery\VminfoDiscovery;
use UpdiveNSM\Interfaces\Polling\VminfoPolling;
use UpdiveNSM\OS;
use UpdiveNSM\Polling\ModuleStatus;

class Vminfo implements \UpdiveNSM\Interfaces\Module
{
    use SyncsModels;
    ...
    public function shouldDiscover(OS $os, ModuleStatus $status): bool
    {
        ...
        return $status->isEnabledAndDeviceUp($os->getDevice(), check_snmp: ! UpdiveNSMConfig::get('enable_libvirt')) && $os instanceof VminfoDiscovery;
    }
