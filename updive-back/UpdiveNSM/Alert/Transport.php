...
use UpdiveNSM\Interfaces\Alert\Transport as TransportInterface;
...
abstract class Transport implements TransportInterface
{
    ...
    {
        $list = [];
        foreach (glob(base_path('UpdiveNSM/Alert/Transport/*.php')) as $file) {
    ...
    {
        $colors = [
            AlertState::CLEAR => UpdiveNSMConfig::get('alert_colour.ok'),
            AlertState::ACTIVE => UpdiveNSMConfig::get('alert_colour.bad'),
            AlertState::ACKNOWLEDGED => UpdiveNSMConfig::get('alert_colour.acknowledged'),
            AlertState::WORSE => UpdiveNSMConfig::get('alert_colour.worse'),
            AlertState::BETTER => UpdiveNSMConfig::get('alert_colour.better'),
            AlertState::CHANGED => UpdiveNSMConfig::get('alert_colour.changed'),
        ];
    ...
    {
        return 'UpdiveNSM\\Alert\\Transport\\' . ucfirst($type);
    }
