 ...
 * 1. Mapping UpdiveNSM alert states to PagerTree event types
 * 2. Sending UpdiveNSM alert_id as PagerTree Id.
 * 3. Sending UpdiveNSM alert title as PagerTree Title
 * 4. Sending UpdiveNSM alert msg as Pagertree Description
 *
 * PagerTree webhook integration documentation --
 * https://pagertree.com/docs/integration-guides/webhook
 *
 * When UpdiveNSM alert state changes, webhook updates corresponding
...
class Pagertree extends Transport
{
    ...
    private function testMessage(): string
    {
        ...
        $event = [
            'event_type' => 'create',
            'Id' => $test_id,
            'Title' => 'UpdiveNSM PagerTree Test Alert',
