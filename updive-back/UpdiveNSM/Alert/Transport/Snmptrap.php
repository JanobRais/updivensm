 ...
 * SNMP Trap Transport
 *
 * Sends UpdiveNSM alerts as SNMPv2c TRAPs or INFORMs to a northbound receiver.
...
class Snmptrap extends Transport
{
    ...
    public function deliverAlert(array $alert_data): bool
    {
        ...
        $binary = UpdiveNSMConfig::get('snmptrap', '/usr/bin/snmptrap');
        ...
        return [
            'config' => [
                ...
                [
                    ...
                    'descr' => 'Trap notification OID, e.g. UpdiveNSM-NOTIFICATIONS-MIB::defaultAlertEvent',
                    'type' => 'text',
                    'default' => 'UpdiveNSM-NOTIFICATIONS-MIB::defaultAlertEvent',
                ],
                [
                    'title' => 'PDU Type',
                    'name' => 'snmptrap-pdu',
                ...
                [
                    ...
                    'type' => 'text',
                    'default' => '/opt/UpdiveNSM/mibs/UpdiveNSM',
                ],
            ],
            'validation' => [
