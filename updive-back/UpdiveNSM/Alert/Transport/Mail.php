...
class Mail extends Transport
{
    public function deliverAlert(array $alert_data): bool
    {
        ...
        $html = UpdiveNSMConfig::get('email_html');
        ...
        try {
            return \UpdiveNSM\Util\Mail::send($emails, $alert_data['title'], $msg, $html, $this->config['bcc'] ?? false, $this->config['attach-graph'] ?? null);
        } catch (Exception $e) {
