...
class InfluxDBv2 extends BaseDatastore
{
    ...
    public function __construct()
    {
        ...
        try {
            $host = UpdiveNSMConfig::get('influxdbv2.host', 'localhost');
            $transport = UpdiveNSMConfig::get('influxdbv2.transport', 'http');
            $port = UpdiveNSMConfig::get('influxdbv2.port', 8086);
            $bucket = UpdiveNSMConfig::get('influxdbv2.bucket', 'UpdiveNSM');
            $organization = UpdiveNSMConfig::get('influxdbv2.organization', '');
            $allow_redirects = UpdiveNSMConfig::get('influxdbv2.allow_redirects', true);
            $token = UpdiveNSMConfig::get('influxdbv2.token', '');
            $debug = UpdiveNSMConfig::get('influxdbv2.debug', false);
            $log_file = UpdiveNSMConfig::get('influxdbv2.log_file', UpdiveNSMConfig::get('log_file'));
            $timeout = UpdiveNSMConfig::get('influxdbv2.timeout', 1);
            $verify = UpdiveNSMConfig::get('influxdbv2.verify', false);
            $batch_size = UpdiveNSMConfig::get('influxdbv2.batch_size', 1000);
            $max_retry = UpdiveNSMConfig::get('influxdbv2.max_retry', 3);
    ...
    {
        return UpdiveNSMConfig::get('influxdbv2.enable', false);
    }
    ...
    public function write(string $measurement, array $fields, array $tags = [], array $meta = []): void
    {
        ...
        $excluded_groups = UpdiveNSMConfig::get('influxdbv2.groups-exclude');
        ...
        if (UpdiveNSMConfig::get('influxdbv2.debug') === true) {
