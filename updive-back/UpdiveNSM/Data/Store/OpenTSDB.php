 ...
 * @copyright  2017 Yacine Benamsili <https://github.com/yac01/UpdiveNSM.git>
...
class OpenTSDB extends BaseDatastore
{
    ...
    {
        parent::__construct();
        $host = UpdiveNSMConfig::get('opentsdb.host');
        $port = UpdiveNSMConfig::get('opentsdb.port', 2181);
        try {
    ...
    {
        return UpdiveNSMConfig::get('opentsdb.enable', false);
    }
}
