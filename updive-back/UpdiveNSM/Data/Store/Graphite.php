...
class Graphite extends BaseDatastore
{
    ...
    {
        parent::__construct();
        $host = UpdiveNSMConfig::get('graphite.host');
        $port = UpdiveNSMConfig::get('graphite.port', 2003);
        try {
        ...
        $this->prefix = UpdiveNSMConfig::get('graphite.prefix', '');
    }
    ...
    {
        return UpdiveNSMConfig::get('graphite.enable', false);
    }
