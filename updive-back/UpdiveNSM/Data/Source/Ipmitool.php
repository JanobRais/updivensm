...
use UpdiveNSM\Exceptions\IpmiConnectionFailed;
...
class Ipmitool
{
    ...
    public function __construct(
        ...
        $this->binary = UpdiveNSMConfig::get('ipmitool', 'ipmitool');
    ...
    public function command(array $commands): string
    {
        ...
        foreach (UpdiveNSMConfig::get('ipmi.type', []) as $ipmi_type) {
            try {
    ...
    private function isLocalhost(): bool
    {
        return in_array($this->hostname, [
            ...
            '127.0.0.1',
            '::1',
            UpdiveNSMConfig::get('own_hostname'),
        ]);
    }
