...
namespace UpdiveNSM\Data\Graphing;
...
class GraphParameters implements \Stringable
{
    ...
    public function __construct(array $vars)
    {
        ...
        $this->font = UpdiveNSMConfig::get('mono_font');
    ...
    private function graphColors(): array
    {
        ...
        $def_colors = UpdiveNSMConfig::get($style == 'dark' ? 'rrdgraph_def_text_dark' : 'rrdgraph_def_text');
        $def_font = ltrim(UpdiveNSMConfig::get($style == 'dark' ? 'rrdgraph_def_text_color_dark' : 'rrdgraph_def_text_color'), '#');
    ...
    private function extractType(string $type): array
    {
        ...
        $type = basename($graphtype['type'] ?? $type);
