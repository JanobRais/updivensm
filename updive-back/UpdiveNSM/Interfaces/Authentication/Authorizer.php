...
namespace UpdiveNSM\Interfaces\Authentication;
...
interface Authorizer
{
    ...
    /**
     * Indicates if the authentication happens within the UpdiveNSM process, or external to it.
     * If the former, UpdiveNSM provides a login form, and the user must supply the username. If the latter, the authenticator supplies it via getExternalUsername() without user interaction.
     * This is an important distinction, because at the point this is called if the authentication happens out of process, the user is already authenticated and UpdiveNSM must not display a login form - even if something fails.
     *
     * @return bool
     */
