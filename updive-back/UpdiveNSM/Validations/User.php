...
class User extends BaseValidation
{
    ...
    public function validate(Validator $validator): void
    {
        ...
        $lnms_username = \config('UpdiveNSM.user');
        $lnms_groupname = \config('UpdiveNSM.group');
        ...
        if ($lnms_username) {
            $dir = UpdiveNSMConfig::get('install_dir');
            $log_dir = UpdiveNSMConfig::get('log_dir', "$dir/logs");
            $rrd_dir = UpdiveNSMConfig::get('rrd_dir', "$dir/rrd");
            ...
            if (! UpdiveNSMConfig::get('installed_from_package')) {
                ...
                if (! empty($find_result)) {
                    ...
                    $ignore_files = [
                        ...
                        "$dir/.pki/", // ignore files/folders created by setting the UpdiveNSM home directory to the install directory
                    ];
            ...
            $validator->warn("You don't have UpdiveNSM_USER set, this most likely needs to be set to 'UpdiveNSM'");
        }
    }
}
