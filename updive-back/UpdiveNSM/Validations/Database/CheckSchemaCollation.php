...
namespace UpdiveNSM\Validations\Database;

use UpdiveNSM\DB\Eloquent;
use UpdiveNSM\Interfaces\Validation;
use UpdiveNSM\Interfaces\ValidationFixer;
    ...
    public function validate(): ValidationResult
    {
        ...
        if (empty($collation) !== true) {
            return ValidationResult::fail(
                ...
                'Check https://community.UpdiveNSM.org/t/new-default-database-charset-collation/14956 for info on how to fix.'
            )->setFixer(self::class);
        }
        ...
        if (empty($collation_tables) !== true) {
            return ValidationResult::fail('MySQL tables collation is wrong: ')
                ->setFix('Check https://community.UpdiveNSM.org/t/new-default-database-charset-collation/14956 for info on how to fix.')
                ->setFixer(self::class)
