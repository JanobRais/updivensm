...
class Configuration extends BaseValidation
{
    ...
    {
        // Test transports
        if (UpdiveNSMConfig::get('alerts.email.enable') == true) {
            $validator->warn('You have the old alerting system enabled - this is to be deprecated on the 1st of June 2015: https://groups.google.com/forum/#!topic/UpdiveNSM-project/1llxos4m0p4');
        }
        ...
        if (UpdiveNSMConfig::has('validation.encryption.test')) {
            try {
                if (\Crypt::decryptString(UpdiveNSMConfig::get('validation.encryption.test')) !== 'UpdiveNSM') {
            ...
            UpdiveNSMConfig::persist('validation.encryption.test', \Crypt::encryptString('UpdiveNSM'));
        }
    }
