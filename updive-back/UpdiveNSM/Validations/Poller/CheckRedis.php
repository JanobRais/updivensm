...
class CheckRedis implements \UpdiveNSM\Interfaces\Validation
{
    /**
     * @inheritDoc
     */
    public function validate(): ValidationResult
    {
        ...
        if ($driver == 'redis' || (\App\Facades\UpdiveNSMConfig::get('distributed_poller') && \App\Models\PollerCluster::isActive()->count() > 2)) {
