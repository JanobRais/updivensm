...
namespace UpdiveNSM\Validations\Poller;
...
class CheckPythonWrapper implements \UpdiveNSM\Interfaces\Validation
{
    /** @var bool */
    ...
    public function validate(): ValidationResult
    {
        ...
        $cron = UpdiveNSMConfig::locateBinary('cron');
    ...
    private function wrapperCronEnabled(): bool
    {
        ...
        $files[] = '/etc/crontab';
        $files[] = '/var/spool/cron/crontabs/UpdiveNSM';
