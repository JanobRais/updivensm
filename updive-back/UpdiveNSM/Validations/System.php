...
class System extends BaseValidation
{
    ...
    public function validate(Validator $validator): void
    {
        ...
        $rotation_file = '/etc/logrotate.d/UpdiveNSM';
        if (! file_exists($rotation_file) && ! UpdiveNSMConfig::get('installed_from_package')) {
            $validator->warn('Log rotation not enabled, could cause disk space issues', "sudo cp $install_dir/misc/UpdiveNSM.logrotate $rotation_file");
        }
    }
}
