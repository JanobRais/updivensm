...
use UpdiveNSM\Exceptions\FileWriteFailedException;
...
class EnvHelper
{
    ...
    /**
     * Detect if UpdiveNSM is installed from the official Docker image.
     *
     * @return bool
     */
    public static function UpdiveNSMDocker()
    {
        return getenv('UpdiveNSM_DOCKER') === '1';
    }
}
