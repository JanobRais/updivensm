...
class Rewrite
{
    ...
    public static function location($location)
    {
        ...
        if (is_array(UpdiveNSMConfig::get('location_map_regex'))) {
            foreach (UpdiveNSMConfig::get('location_map_regex') as $reg => $val) {
        ...
        if (is_array(UpdiveNSMConfig::get('location_map_regex_sub'))) {
            foreach (UpdiveNSMConfig::get('location_map_regex_sub') as $reg => $val) {
                if (preg_match($reg, $location)) {
        ...
        if (UpdiveNSMConfig::has("location_map.$location")) {
            $location = UpdiveNSMConfig::get("location_map.$location");
        }
