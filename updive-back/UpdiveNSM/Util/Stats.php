...
class Stats
{
    public static function submit(): void
    {
        ...
        if ($stats->isEnabled()) {
            Http::client()
                ->asForm()
                ->post(\App\Facades\UpdiveNSMConfig::get('callback_post'), [
    ...
    public function clearStats(): void
    {
        ...
        $response = Http::client()
            ->asForm()
            ->post(\App\Facades\UpdiveNSMConfig::get('callback_clear'), ['uuid' => $uuid]);
    ...
    private function collectStats(): array
    {
        ...
        return [
            ...
            'UpdiveNSM_release' => $this->selectStatic($version->release(), 'release'),
        ];
    }
