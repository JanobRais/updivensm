...
class GitHub
{
    ...
    protected $markdown;
    protected $github = 'https://api.github.com/repos/UpdiveNSM/UpdiveNSM';
    ...
    public function getPullRequests($date, $after = null)
    {
        ...
        $query = <<<GRAPHQL
{
  search(query: "repo:UpdiveNSM/UpdiveNSM is:pr is:merged merged:>=$date", type: ISSUE, first: 100$after) {
    edges {
      node {
        ... on PullRequest {
          number
...
GRAPHQL;
    ...
    {
        $version_file = 'UpdiveNSM/Util/Version.php';
