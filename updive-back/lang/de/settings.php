    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Benutzer werden von UpdiveNSM gelöscht nach diesen Tagen Inaktivität. 0 bedeutet nie und der Benutzer wird neu erstellt wenn er sich erneut anmeldet',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'Aktiviere systemweites Distributed Polling. Dies wird genutzt für Lastverteilung und nicht remote Polling. Lesen Sie hierzu folgende Dokumentation: https://docs.UpdiveNSM.org/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'Diese Domain wird genutzt für Netzwerkautoerkennung und andere Prozesse. UpdiveNSM wird versuchen diese Hostnamen hinzuzufügen.',
        ],
        'nfsen_enable' => [
        ...
        'own_hostname' => [
            ...
            'help' => 'Sollte auf den hostname/ip des UpdiveNSM Servers gesetzt werden',
        ],
        'oxidized' => [
            'default_group' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Verzeichnis für RRD Dateien. Standardmässig ist RRD innerhalb des UpdiveNSM Verzeichnisses. Eine Änderung verschiebt nicht die vorhandenen RRD Dateien.',
        ],
        'rrd_purge' => [
