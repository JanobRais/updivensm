...
return [
    ...
    'dev:check' => [
        'description' => 'UpdiveNSM-ის კოდის შემოწმებები. პარამეტრების გარეშე გაშვება ყველა შემოწმებას გაუშვებს',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'snmprec ფაილის სახელი (მხოლოდ სახელი) განახლებისთვის, ან UpdiveNSM-ში დასამატებლად. თუ ფაილი მითითებული არაა, მოწყობილობები არც დაემატება, არც განახლდება.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'თუ თქვენ არ გაქვთ ძველი გასაღები, ყველა დაშიფრული მონაცემები უნდა წაშალოთ, რომ UpdiveNSM-ის ზოგიერთი ფუნქცია გამოიყენოთ',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'მეტი ინფორმაციისთვის იხილეთ https://docs.UpdiveNSM.org/Extensions/Smokeping/"',
