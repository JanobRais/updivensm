...
return [
    'device' => [
        ...
        'create' => ['label' => 'Add Devices', 'description' => 'Add new devices to UpdiveNSM'],
        'update' => ['label' => 'Edit Devices', 'description' => 'Modify device settings'],
        'delete' => ['label' => 'Delete Devices', 'description' => 'Remove devices from UpdiveNSM'],
    ...
    'api' => [
        'title' => 'API Access',
        'access' => ['label' => 'API Access', 'description' => 'Access the UpdiveNSM REST API'],
    ],
    ...
    'poller' => [
        ...
        'delete' => ['label' => 'Delete Pollers', 'description' => 'Remove pollers from UpdiveNSM'],
    ],
    ...
    'settings' => [
        'title' => 'Settings',
        'view' => ['label' => 'View Settings', 'description' => 'View global UpdiveNSM settings'],
        'update' => ['label' => 'Edit Settings', 'description' => 'Modify global UpdiveNSM settings'],
    ],
