...
return [
    ...
    'dev:check' => [
        'description' => 'UpdiveNSM 程式碼檢查。不帶選項執行時會執行所有檢查',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => '要更新或加入到 UpdiveNSM 的 snmprec 檔案（僅檔名本體）。若未指定，將不新增或更新裝置。',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => '若沒有舊金鑰，必須刪除所有加密資料，才能繼續使用部分 UpdiveNSM 功能',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => '更多資訊請見 https://docs.UpdiveNSM.org/Extensions/Smokeping/',
