...
return [
    ...
    'dev:check' => [
        'description' => 'Проверки кода UpdiveNSM. Запуск без опций выполняет все проверки',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Имя файла (только базовое имя) файла snmprec для обновления или добавления в UpdiveNSM. Если файл не указан, устройство не будет добавлено или обновлено.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'Если у вас нет старого ключа, вы должны удалить все зашифрованные данные, чтобы продолжить использовать определенные функции UpdiveNSM',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Для получения дополнительной информации смотрите https://docs.UpdiveNSM.org/Extensions/Smokeping/"',
