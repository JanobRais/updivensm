...
/*
 * UpdiveNSM module to poll Nagios Services
 *
...
if (isset($options['h'])) {
    ...
    $scheduler = UpdiveNSMConfig::get('schedule_type.services');
...
$string = $argv[0] . ' ' . date(\App\Facades\UpdiveNSMConfig::get('dateformat.compact'))
