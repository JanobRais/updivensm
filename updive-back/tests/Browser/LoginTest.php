...
namespace UpdiveNSM\Tests\Browser;
...
use UpdiveNSM\Tests\Browser\Pages\DashboardPage;
use UpdiveNSM\Tests\Browser\Pages\LoginPage;
use UpdiveNSM\Tests\Browser\Pages\TwoFactorPage;
use UpdiveNSM\Tests\DuskTestCase;
...
//    }
    ...
    public function test2faLogin(): void
    {
        $this->browse(function (Browser $browser): void {
            ...
            UpdiveNSMConfig::persist('twofactor', true); // set to db
