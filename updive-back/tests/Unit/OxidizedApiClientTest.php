...
final class OxidizedApiClientTest extends TestCase
{
    ...
    {
        parent::setUp();
        UpdiveNSMConfig::set('oxidized.enabled', true);
        UpdiveNSMConfig::set('oxidized.url', 'http://oxidized:8888');
    }
    ...
    {
        UpdiveNSMConfig::set('oxidized.enabled', false);
    ...
    {
        UpdiveNSMConfig::set('oxidized.reload_nodes', true);
