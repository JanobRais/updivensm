...
use InfluxDB\Point;
use UpdiveNSM\Data\Store\InfluxDB;
...
final class InfluxDBStoreTest extends TestCase
{
    ...
    {
        UpdiveNSMConfig::set('influxdb.host', '');
        UpdiveNSMConfig::set('influxdb.port', 'abc');
    ...
    {
        UpdiveNSMConfig::set('influxdb.measurements', ['testmeasure', 'anothermeasure']);
    ...
    {
        UpdiveNSMConfig::set('influxdb.measurements', ['anothermeasure', 'yetanothermeasure']);
