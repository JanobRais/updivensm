...
use UpdiveNSM\Data\Store\Prometheus;
...
final class PrometheusStoreTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        UpdiveNSMConfig::set('prometheus.url', 'http://fake:9999');
    }
    ...
    public function testSimpleWrite(): void
    {
        ...
        LaravelHttp::assertSent(fn (\Illuminate\Http\Client\Request $request) => $request->method() == 'POST' &&
            $request->url() == 'http://fake:9999/metrics/job/UpdiveNSM/instance/testhost/measurement/testmeasure/ifName/testifname/type/testtype' &&
