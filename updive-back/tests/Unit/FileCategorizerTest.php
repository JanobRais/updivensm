...
namespace UpdiveNSM\Tests\Unit;

use Illuminate\Support\Arr;
use UpdiveNSM\Tests\TestCase;
use UpdiveNSM\Util\FileCategorizer;
...
final class FileCategorizerTest extends TestCase
{
    ...
    public function testResources(): void
    {
        $this->assertCategorized([
            'resources' => [
                'resources/js/app.js',
                'resources/js/components/UpdiveNSMSetting.vue',
                'resources/views/layouts/UpdiveNSMv1.blade.php',
            ],
            'php' => [
                'resources/views/layouts/UpdiveNSMv1.blade.php',
            ],
    ...
    public function testOsFiles(): void
    {
        ...
        $this->assertCategorized([
            ...
            'os-files' => [
                'UpdiveNSM/OS/ThreeCom.php',
                'UpdiveNSM/OS/ArrisDsr4410md.php',
                'UpdiveNSM/OS/AdvaFsp3kr7.php',
                'UpdiveNSM/OS/XirrusAos.php',
            ],
            'php' => [
                'UpdiveNSM/OS/ThreeCom.php',
                'UpdiveNSM/OS/ArrisDsr4410md.php',
