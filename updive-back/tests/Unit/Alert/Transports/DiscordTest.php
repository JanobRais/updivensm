...
namespace UpdiveNSM\Tests\Unit\Alert\Transports;
...
final class DiscordTest extends TestCase
{
        ...
        Http::assertSent(function (Request $request) {
            ...
            assertEquals(
                [
                    'embeds' => [
                        [
                            'title' => '#000 Testing transport from UpdiveNSM',
                            'color' => 16711680,
    ...
    public function testDiscordDelivery(): void
    {
        ...
        $alert_data['msg'] = 'This test alert should not have image <img class="UpdiveNSM-graph" src="google.jpeg" /> or <h2>html tags</h2></br>';
