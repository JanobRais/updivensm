...
final class ProxyTest extends TestCase
{
    ...
    {
        $this->assertEquals('UpdiveNSM/' . Version::VERSION, Http::client()->getOptions()['headers']['User-Agent']);
    }

    public function testProxyIsNotSet(): void
    {
        UpdiveNSMConfig::set('http_proxy', '');
        UpdiveNSMConfig::set('https_proxy', '');
        UpdiveNSMConfig::set('no_proxy', '');
    ...
    {
        UpdiveNSMConfig::set('http_proxy', 'http://proxy:5000');
        UpdiveNSMConfig::set('https_proxy', 'tcp://proxy:5183');
        UpdiveNSMConfig::set('no_proxy', 'localhost,127.0.0.1,::1,.domain.com');
        $client_options = Http::client()->getOptions();
