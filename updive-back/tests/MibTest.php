...
final class MibTest extends TestCase
{
    ...
    {
        $output = shell_exec('snmptranslate -M +' . UpdiveNSMConfig::get('mib_dir') . ":$dir -m +ALL SNMPv2-MIB::system 2>&1");
    ...
    public function testMibContents($path, $file, $mib_name): void
    {
        ...
        $output = shell_exec('snmptranslate -M +' . UpdiveNSMConfig::get('mib_dir') . ":$path -m +$mib_name SNMPv2-MIB::system 2>&1");
        $errors = str_replace("SNMPv2-MIB::system\n", '', $output);
