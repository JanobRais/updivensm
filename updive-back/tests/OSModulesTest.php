...
use UpdiveNSM\Data\Source\Fping;
use UpdiveNSM\Data\Source\FpingResponse;
...
use UpdiveNSM\Util\ModuleTestHelper;
...
final class OSModulesTest extends DBTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // backup modules
        $this->discoveryModules = UpdiveNSMConfig::get('discovery_modules');
        $this->pollerModules = UpdiveNSMConfig::get('poller_modules');
    }

    protected function tearDown(): void
    {
        // restore modules
        UpdiveNSMConfig::set('discovery_modules', $this->discoveryModules);
        UpdiveNSMConfig::set('poller_modules', $this->pollerModules);
