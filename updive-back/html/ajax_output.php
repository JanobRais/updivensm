...
if ($id && is_file(\App\Facades\UpdiveNSMConfig::get('install_dir') . "/includes/html/output/$id.inc.php")) {
    require \App\Facades\UpdiveNSMConfig::get('install_dir') . "/includes/html/output/$id.inc.php";
}
