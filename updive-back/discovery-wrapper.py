#! /usr/bin/env python3
"""
This is a Bootstrap script for wrapper.py, in order to retain compatibility with earlier UpdiveNSM setups
"""
...
import UpdiveNSM
import UpdiveNSM.wrapper as wrapper
...
config = UpdiveNSM.get_config_data(os.path.dirname(os.path.realpath(__file__)))
if not config:
...
logger = UpdiveNSM.logger_get_logger(log_file, debug=args.debug)
