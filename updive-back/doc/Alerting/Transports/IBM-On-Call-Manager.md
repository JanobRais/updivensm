...
UpdiveNSM can integrate with IBM On Call Manager by using a webhook URL you create by adding the UpdiveNSM integration.

The webhook URL (referred to as `ocm-url`) can be found under 'Integrations' in the IBM On Call Manager portal after selecting UpdiveNSM as the integration.
...
```json
{
  "eventSource": {
    ...
    "displayName": "UpdiveNSM Alerts - DBAoC",
    "type": "server",
    "sourceID": "UpdiveNSM-DBAoC"
  },
  "resourceAffected": {
