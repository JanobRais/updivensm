...
UpdiveNSM uses alert grouping by alert rule, which can produce an array
...
| Alertmanager Options: | source=UpdiveNSM <br/> customlabel=value <br/> extra_dynamic_value=variable_name |
