...
| Use JSON | When enabled, the raw body of the alert template is sent as-is. Use this for Adaptive Card payloads. When disabled, UpdiveNSM builds a `MessageCard` from the alert data automatically |
...
4. Paste the URL into the UpdiveNSM transport configuration.
5. Leave **Use JSON** unchecked — your existing alert templates work without modification.

### Alert templates

MessageCard - JSON off:
[Alert Template Microsoft Teams - MessageCard Markdown](https://docs.UpdiveNSM.org/Alerting/Templates/#microsoft-teams-markdown)

MessageCard - JSON on:
[Alert Template Microsoft Teams - MessageCard JSON](https://docs.UpdiveNSM.org/Alerting/Templates/#microsoft-teams-json)

AdaptiveCard - JSON on:
[Alert Template Microsoft Teams - AdaptiveCard JSON](https://docs.UpdiveNSM.org/Alerting/Templates/#microsoft-teams-adaptivecard-json)
