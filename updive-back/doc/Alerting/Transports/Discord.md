...
Graphs can be included in the template using: ```<img class="UpdiveNSM-graph" src=""/>```. The rest of the html tags are stripped from the message.


 The Options field supports JSON/Form Params listed
in the 
[Discord Docs](https://discordapp.com/developers/docs/resources/webhook#execute-webhook). Fields to embed is a comma separated list from the [Alert Data](https://github.com/UpdiveNSM/UpdiveNSM/blob/master/UpdiveNSM/Alert/AlertData.php)).
