...
can be useful within the templates or routes. If you perform a test of the UpdiveNSM transport 
...
```
{
    ...
    "title": "{{ $alert->title }}",
    "link_to_upstream_details": "{{ \UpdiveNSM\Util\Url::deviceUrl($device) }}",
}
```
