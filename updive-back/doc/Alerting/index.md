...
UpdiveNSM alerting is built from a few connected parts. This page shows what each part does and how they work together.
...
If a rule has no operation, UpdiveNSM can still raise the alert, but no notification is sent.
...
After that you also need to tell UpdiveNSM how to notify you when an
