...
Create customised dashboards in UpdiveNSM per user. You can share
dashboards with other users. You can also make a custom dashboard and
default it for all users in UpdiveNSM.
...
UpdiveNSM has a whole list of Widgets to select from.
...
- Device Summary vertical: List device totals, up, down, ignored,
  disabled. Same for ports and services.
- Eventlog: Displays all events with your devices and UpdiveNSM.
- External Image: can be used to show external images on your
  dashboard. Or images from inside UpdiveNSM.
...
- <http://UpdiveNSM.example.com/graph.php?id=333%2C444&type=multiport_bits_separate&legend=no&absolute=1&from=-14200&width=@AUTO_WIDTH@&height=@AUTO_HEIGHT@>
