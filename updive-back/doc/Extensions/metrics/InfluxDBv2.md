...
!!! setting "poller/influxdbv2"
    ...
    lnms config:set influxdbv2.bucket 'UpdiveNSM'
    lnms config:set influxdbv2.token 'admin'
    lnms config:set influxdbv2.allow_redirect true
    lnms config:set influxdbv2.organization 'UpdiveNSM'
    lnms config:set influxdbv2.debug false
    lnms config:set influxdbv2.log_file '/opt/UpdiveNSM/logs/influxdbv2.log'
