...
UpdiveNSM can interpret, display and group certain additional information on ports.
...
- Add `ifAlias` from `/opt/UpdiveNSM/scripts/` or download it from
  [here](https://github.com/UpdiveNSM/UpdiveNSM/blob/master/scripts/ifAlias)
...
There are no changes to be made or additions to install for the polling UpdiveNSM.
