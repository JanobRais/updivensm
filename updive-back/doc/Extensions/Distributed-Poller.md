...
**Distributed Polling** enables UpdiveNSM to spread polling and discovery tasks across multiple servers for horizontal scaling.
...
In addition to separating UpdiveNSM components across different servers, distributed polling allows poller workloads to be balanced among multiple nodes.

UpdiveNSM consists of several core services:
...
Not all services UpdiveNSM relies on can support High Availability. You can find
...
Follow the [installation guide](../Installation/Install-UpdiveNSM.md), skipping database and web configuration steps.
