...
=== "Agent"
    ...
    ```bash
    wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/agent-local/freeswitch -O /usr/lib/check_mk_agent/local/freeswitch`
    ```
...
=== "SNMP Extend"
    ...
    ```bash
    wget https://github.com/UpdiveNSM/UpdiveNSM-agent/raw/master/agent-local/freeswitch -O /etc/snmp/freeswitch
    ```
