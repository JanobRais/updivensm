...
2: Download the script to your Raspberry Pi. 
    ...
    ```bash
    wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/snmp/rpigpiomonitor.php
...
3: (optional) Download the example configuration to your Raspberry Pi. 
    ...
    ```bash 
    wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/snmp/rpigpiomonitor.ini
...
8: Restart snmpd on your Raspberry Pi and, if your Raspberry Pi is already present in UpdiveNSM, perform a manual rediscover.
