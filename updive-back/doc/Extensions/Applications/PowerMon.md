...
1. Download the python script onto the host:
    ...
    ```bash
    wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/snmp/powermon-snmp.py -O /usr/local/bin/powermon-snmp.py
    ```
...
```
    ...
    > interpreted correctly by UpdiveNSM.
...
7. You're now ready to enable the application in UpdiveNSM.
