...
Install/Setup:
For Install/Setup Local UpdiveNSM RRDCached: Please see [RRDCached](../RRDCached.md)
...
```
wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/agent-local/rrdcached -O /etc/snmp/rrdcached
```
