...
agent = A 0/1 boolean for if this is being used as a UpdiveNSM
...
=== "SNMP Extend"
    ...
    1. Copy the bind shell script, to the desired host.
        ...
        ```bash
        wget https://github.com/UpdiveNSM/UpdiveNSM-agent/raw/master/snmp/bind -O /etc/snmp/bind
        ```
...
=== "Agent"
    ...
    2. Download the script onto the desired host:
        ...
        ```bash
        wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/snmp/bind -O /usr/lib/check_mk_agent/local/bind
        ```
