...
2. Copy the Perl script to the desired host (the host must be added to UpdiveNSM devices)

    ```bash
    wget https://github.com/UpdiveNSM/UpdiveNSM-agent/raw/master/snmp/portactivity -O /etc/snmp/portactivity
    ```
