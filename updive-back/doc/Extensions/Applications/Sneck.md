...
This is for replacing Nagios/Icinga or the UpdiveNSM service
integration in regards to NRPE. This allows UpdiveNSM to query what
...
5. In UpdiveNSM, enable the application for the server in question or wait for auto discovery to find it.
