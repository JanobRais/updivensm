...
1.  Copy the shell script to the desired host.
    ...
    ```bash
    wget https://github.com/UpdiveNSM/UpdiveNSM-agent/raw/master/snmp/dhcp -O /etc/snmp/dhcp
    ```
...
3.  Edit your snmpd.conf file
    ...
    === "If using cron"
        ...
        Setup cronjob to run every 5 minutes. add the following to cron `\etc/crontab.d/UpdiveNSM_dhcp`:
