...
stats.  So UpdiveNSM polls will ultimately be reflected in your
stats/charts.
...
=== "SNMP Extend"
    ...
    1. Copy the freeradius shell script, to the desired host.
        ...
        ```bash
        wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/snmp/freeradius.sh -O /etc/snmp/freeradius.sh
        ```
...
=== "Agent"
    ...
    ```bash
    wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/snmp/freeradius.sh -O /usr/lib/check_mk_agent/local/freeradius.sh`
    ```
