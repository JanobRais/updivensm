...
1. Copy the shell script, icecast-stats.sh, to the desired host (the host must be added to UpdiveNSM devices)

    ```bash
    wget https://github.com/UpdiveNSM/UpdiveNSM-agent/raw/master/snmp/icecast-stats.sh -O /etc/snmp/icecast-stats.sh
    ```
