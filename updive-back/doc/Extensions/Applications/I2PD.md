...
This is simple Python3-based SNMP extend script for monitoring I2PD routing daemon using UpdiveNSM. Script provides very basic metrics for example tunnel success rate, network status and throughput monitoring.
...
1. Download script onto host running i2pd and snmpd
   ...
   ```
   wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/snmp/i2pd-stats.py -O /etc/snmp/i2pd-stats.py 
   ```
...
Go to *UpdiveNSM -> Alerts -> Alert rules* and click **Create rule from collection**
