...
=== "Direct"
    ...
    The UpdiveNSM polling host must be able to connect to port 8082 on the
...
=== "SNMP Extend"
    ...
    ```bash
    wget https://github.com/UpdiveNSM/UpdiveNSM-agent/raw/master/snmp/powerdns-recursor -O /etc/snmp/powerdns-recursor
    ```
