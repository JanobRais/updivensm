...
script](https://github.com/UpdiveNSM/UpdiveNSM-agent/blob/master/snmp/asterisk)
to `/etc/snmp/` on your asterisk server.

```bash
wget https://raw.githubusercontent.com/UpdiveNSM/UpdiveNSM-agent/master/snmp/asterisk -O /etc/snmp/asterisk
```
