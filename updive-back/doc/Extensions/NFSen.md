...
> The installation of NFSen is out of scope for this document / UpdiveNSM
...
that matches what is configured in UpdiveNSM, because the rrd files
NfSen creates is named after the source name (ident), and it doesn't
allow you to use an IP address instead. However, in UpdiveNSM, if your
...
ln -s mychannel.rrd UpdiveNSMdeviceIP.rrd
```
