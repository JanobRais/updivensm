# Get ready to contribute to UpdiveNSM

This document is intended to help you get your local environment set
up to contribute code to the UpdiveNSM project.
...
- Another directory on your UpdiveNSM server
...
UpdiveNSM uses continuous integration to test code changes to help
...
DB_TEST_PORT=""          # port
DB_TEST_DATABASE="UpdiveNSM_phpunit_78hunjuybybh" # database
...
[Snmpsim](https://github.com/etingof/snmpsim).  UpdiveNSM has a set of
scripts to make it easier to work with snmprec files.
[UpdiveNSM Snmpsim helpers](https://github.com/UpdiveNSM/UpdiveNSM-snmpsim)

### Laravel documentation

You can find a lot of how UpdiveNSM works by following the [Laravel Documentation](https://laravel.com/docs/)
