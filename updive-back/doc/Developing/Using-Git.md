...
If you want to help develop UpdiveNSM and haven't really used Git
before then this quick primer will help you get started.

Some assumptions:

- Work is being done on a Linux box.
- UpdiveNSM is to be installed in /opt/UpdiveNSM
- You have git installed.
- You have a [GitHub Account](https://github.com/).
- You are using ssh to connect to GitHub (If not, replace
  git@github.com:/yourusername/UpdiveNSM.git with <https://github.com/yourusername/UpdiveNSM.git>.
...
[GitHub](https://github.com/UpdiveNSM/UpdiveNSM/fork), click the 'Fork'
...
```bash
cd /opt/
git clone git@github.com:/yourusername/UpdiveNSM.git
```

#### Add Upstream repo

To be able to pull in changes from the master UpdiveNSM repo you need
to have it setup on your system.

```bash
git remote add upstream https://github.com/UpdiveNSM/UpdiveNSM.git
```

Now you have two configured remotes:

- origin: This is your repository, you can push and pull changes here.
- upstream: This is the main UpdiveNSM repository and you can only pull changes.
...
do this, go to your GitHub page for the UpdiveNSM repo. Now select the
