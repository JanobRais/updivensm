...
Create a new class in `UpdiveNSM\Snmptrap\Handlers` that implements the
`UpdiveNSM\Interfaces\SnmptrapHandler` interface. For example:
...
The handle function inside your new class will receive a UpdiveNSM/Snmptrap/Trap
...
namespace UpdiveNSM\Tests\Feature\SnmpTraps;
