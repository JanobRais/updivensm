...
- `UpdiveNSM/Enum/Sensor.php`: add accordingly, find free icon from [Font Awesome](https://fontawesome.com/icons?d=gallery&m=free)
...
- `UpdiveNSM/Util/ObjectCache.php`: optional - choose menu grouping for the sensor class.
...
```
[UpdiveNSM@nms-test ~]$ lnms device:discover 2 -m sensors
UpdiveNSM Discovery
