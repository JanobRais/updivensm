...
Tests ensure UpdiveNSM works as expected, now and in the future.  New
...
poll a device already added to UpdiveNSM.  Make sure to re-run the
...
`./scripts/composer_wrapper.php install` from your UpdiveNSM root
...
During testing UpdiveNSM will use any info in the snmprec file for snmp
...
1. Add device to UpdiveNSM. It is generic and device_id = 42
