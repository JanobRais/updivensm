...
under `UpdiveNSM/OS`.  The name of this file should be the os name in
camel case for example `airos -> Airos`, `ios-wlc -> IosWlc`.

Your new OS class should extend UpdiveNSM\OS and implement the
...
required polling interface in `UpdiveNSM/Interfaces/Polling/Sensors`.
