...
UpdiveNSM will attempt to detect memory statistics using the standard HOST-RESOURCES-MIB and UCD-SNMP-MIB MIBs.
...
OS Class files reside under `UpdiveNSM\OS`
...
use UpdiveNSM\Interfaces\Polling\MempoolsPolling;

class Example extends \UpdiveNSM\OS implements MempoolsDiscovery, MempoolsPolling
{
    /**
...
use UpdiveNSM\Interfaces\Polling\ProcessorPolling;
use UpdiveNSM\OS;
