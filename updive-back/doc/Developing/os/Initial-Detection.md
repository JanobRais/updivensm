...
OS discovery is how UpdiveNSM detects which OS should be used for a device.
...
`bad_ifXEntry`: This is a list of models for which to tell UpdiveNSM
...
the discovery yaml `resources/definitions/os_discovery/<os>.yaml` or `UpdiveNSM/OS/<os>.php` if
...
At this step we should see all the values retrieved in UpdiveNSM.
