...
You can create a new release on [GitHub](https://github.com/UpdiveNSM/UpdiveNSM/releases/new).
...
- Once the pull request has been merged in for the Changelog, you can
  ...
  [GitHub](https://github.com/UpdiveNSM/UpdiveNSM/releases/new).
- Create two threads on the community site:
  - A changelog thread [example](https://community.UpdiveNSM.org/t/v1-40-release-changelog-may-2018/4228/1)
  - An info thread [example](https://community.UpdiveNSM.org/t/v1-40-may-2018-info/4229/)
- [Tweet it](https://twitter.com/UpdiveNSM)
- [Facebook it](https://www.facebook.com/UpdiveNSM/)
- [Google Plus it](https://plus.google.com/u/1/b/110467424837711353117/)
- [LinkedIn it](https://www.linkedin.com/company/UpdiveNSM/)
