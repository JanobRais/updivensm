...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://UpdiveNSM.org/api/v0/port_security/
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://UpdiveNSM.org/api/v0/port_security/port/123
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://UpdiveNSM.org/api/v0/port_security/device/switch1
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://UpdiveNSM.org/api/v0/port_security/device/5
```
