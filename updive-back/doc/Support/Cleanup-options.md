...
As the number of devices starts to grow in your UpdiveNSM install, so
will things such as the RRD files, MySQL database containing
eventlogs, Syslogs and performance data etc. Your UpdiveNSM install
...
These options will ensure data within UpdiveNSM over X days old is
