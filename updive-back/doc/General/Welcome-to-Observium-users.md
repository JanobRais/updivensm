UpdiveNSM is a fork of Observium.  The reason for the fork has nothing to do
...
UpdiveNSM was forked from [the last GPL-licensed version of Observium][3].
...
UpdiveNSM. This also takes care of moving from one CPU architecture to
another. Give it a try :)

How UpdiveNSM will be different from Observium:
...
Reasons why you might want to use Observium instead of UpdiveNSM:
...
Reasons why you might want to use UpdiveNSM instead of Observium:
...
- You want to make use of the additional features UpdiveNSM can offer.

[1]: http://postman.memetic.org/pipermail/observium/2013-October/003915.html
"Observium edition split announcement"
[2]: https://github.com/UpdiveNSM/UpdiveNSM/blob/master/README.md
"UpdiveNSM README"
[3]: http://fisheye.observium.org/rdiff/Observium?csid=3251&u&N
"Link to Observium license change"
[5]: https://github.com/UpdiveNSM/UpdiveNSM/blob/master/LICENSE.txt
"UpdiveNSM copy of GPL v3"
...
[9]: https://community.UpdiveNSM.org
"UpdiveNSM issue database at GitHub"
[10]: ../Installation/Migrating-from-Observium.md
"Migrating from Observium to UpdiveNSM"
