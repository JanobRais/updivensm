...
This document has been put together to explain what UpdiveNSM does when
...
submits it is included in the standard UpdiveNSM branch you've
...
back system on, you can do this within the About UpdiveNSM page within
...
dynamic site so you can see the results of all contributed stats [here](https://stats.UpdiveNSM.org)

### I want my data removed.
That's easy, simply press 'Clear remote stats' in the About UpdiveNSM page of your control
