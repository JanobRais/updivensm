...
function process_syslog($entry, $update)
{
    ...
    foreach (UpdiveNSMConfig::get('syslog_filter') as $bi) {
    ...
    $syslog_xlate = UpdiveNSMConfig::get('syslog_xlate');
    ...
    if ($entry['device_id']) {
        ...
        if (UpdiveNSMConfig::get('enable_syslog_hooks') && is_array(UpdiveNSMConfig::getOsSetting($os, 'syslog_hook'))) {
            foreach (UpdiveNSMConfig::getOsSetting($os, 'syslog_hook') as $v) {
