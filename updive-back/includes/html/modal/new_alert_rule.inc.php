...
use UpdiveNSM\Alerting\QueryBuilderFilter;

$default_severity = UpdiveNSMConfig::get('alert_rule.severity');
$default_invert_rule_match = UpdiveNSMConfig::get('alert_rule.invert_rule_match');
$default_recovery_alerts = UpdiveNSMConfig::get('alert_rule.recovery_alerts');
$default_acknowledgement_alerts = UpdiveNSMConfig::get('alert_rule.acknowledgement_alerts');
$default_invert_map = UpdiveNSMConfig::get('alert_rule.invert_map');
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="Create">Alert Rule :: <a target="_blank" href="https://docs.UpdiveNSM.org/Alerting/"><i class="fa fa-book fa-1x"></i> Docs</a> </h5>
                </div>
