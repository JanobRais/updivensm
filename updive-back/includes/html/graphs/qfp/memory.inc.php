...
$descr = \UpdiveNSM\Data\Store\Rrd::fixedSafeDescr(short_hrDeviceDescr($components['name']), $descr_len);

$perc = \UpdiveNSM\Util\Number::calculatePercent((int) $components['memory_used'], (int) $tmp_component['memory_total']);

$background = \UpdiveNSM\Util\Color::percentage($perc, 75);
