...
$descr = \UpdiveNSM\Data\Store\Rrd::fixedSafeDescr($storage['storage_descr'], 16);

$percentage = round($storage['storage_perc'], 0);

$background = \UpdiveNSM\Util\Color::percentage($percentage, $storage['storage_perc_warn']);
...
if ($previous) {
    $descr = \UpdiveNSM\Data\Store\Rrd::fixedSafeDescr('Prev ' . $storage['storage_descr'], 16);
