...
$descr = \UpdiveNSM\Data\Store\Rrd::safeDescr(substr(str_pad((string) $toner['supply_descr'], 26), 0, 26));

$background = \UpdiveNSM\Util\Color::percentage(100 - $toner['supply_current']);
