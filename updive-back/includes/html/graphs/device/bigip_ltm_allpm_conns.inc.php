...
/*
 * UpdiveNSM module to display F5 LTM Virtual Server Details
 *
...
$colours = array_merge(\App\Facades\UpdiveNSMConfig::get('graph_colours.mixed'), \App\Facades\UpdiveNSMConfig::get('graph_colours.manycolours'), \App\Facades\UpdiveNSMConfig::get('graph_colours.manycolours'));
$count = 0;
d_echo('<pre>');
