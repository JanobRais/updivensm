...
/*
 * UpdiveNSM module to display F5 LTM Bandwidth Controller Details
 *
...
$colours = array_merge(\App\Facades\UpdiveNSMConfig::get('graph_colours.mixed'), \App\Facades\UpdiveNSMConfig::get('graph_colours.manycolours'));
$colcount = 0;
$count = 0;
