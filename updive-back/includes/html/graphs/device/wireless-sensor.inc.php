...
foreach ($sensors as $index => $sensor) {
    ...
    $colour_index = $index % count(\App\Facades\UpdiveNSMConfig::get('graph_colours.mixed'));
    $colour = \App\Facades\UpdiveNSMConfig::get("graph_colours.mixed.$colour_index");

    $sensor_descr_fixed = \UpdiveNSM\Data\Store\Rrd::fixedSafeDescr($sensor['sensor_descr'], 28);
