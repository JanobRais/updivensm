...
foreach ($sensors as $sensor) {
    ...
    $sensor_descr_fixed = UpdiveNSM\Data\Store\Rrd::fixedSafeDescr($full_descr, $descr_len);
...
if ($stacked_mode && $i > 1) {
    ...
    $aggr_descr = UpdiveNSM\Data\Store\Rrd::fixedSafeDescr('Total (Aggregate)', $descr_len);
