...
switch ($type) {
    case 'alerts':
        ...
        if (\App\Facades\UpdiveNSMConfig::get('alert.transports.mail') === true) {
        ...
        $transports = '';
        $x = 0;
        foreach (\App\Facades\UpdiveNSMConfig::get('alert.transports') as $name => $v) {
            if (\App\Facades\UpdiveNSMConfig::get("alert.transports.$name") === true) {
