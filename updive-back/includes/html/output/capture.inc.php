...
switch ($type) {
    case 'poller':
        $cmd = ['php', \App\Facades\UpdiveNSMConfig::get('install_dir') . '/lnms', 'device:poll', $hostname, '--no-data', '-vv'];
    ...
    case 'snmpwalk':
        ...
        break;
    case 'discovery':
        $cmd = ['php', \App\Facades\UpdiveNSMConfig::get('install_dir') . '/lnms', 'device:discover', $hostname, '-vv'];
