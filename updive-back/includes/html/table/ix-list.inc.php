...
/**
 * UpdiveNSM PeeringDB Integration
 *
...
foreach (dbFetchRows($sql, $params) as $ix) {
    ...
    $response[] = [
        'exchange' => $ix['name'],
        'action' => "<a class='btn btn-sm btn-primary' href='" . \UpdiveNSM\Util\Url::generate(['page' => 'peering', 'section' => 'ix-peers', 'asn' => $asn, 'ixid' => $ix['ix_id']]) . "' role='button'>Show Peers</a>",
