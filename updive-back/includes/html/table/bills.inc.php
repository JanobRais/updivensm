...
foreach (dbFetchRows($sql, $param) as $bill) {
    ...
    $url = \UpdiveNSM\Util\Url::generate(['page' => 'bill', 'bill_id' => $bill['bill_id']]);
    ...
    $bar = \UpdiveNSM\Util\Html::percentageBar(250, 10, $percent, null, $percent . '%', null, null, [
    ...
    if (! $prev && Gate::allows('update', \App\Models\Bill::class)) {
        $actions .= "<a href='" . \UpdiveNSM\Util\Url::generate(['page' => 'bill', 'bill_id' => $bill['bill_id'], 'view' => 'edit']) .
