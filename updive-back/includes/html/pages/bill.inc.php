...
if (Gate::allows('view', $bill)) {
    ...
    echo '<div style="font-weight: bold; float: right;"><a href="' . \UpdiveNSM\Util\Url::generate(['page' => 'bills']) . '/"><i class="fa fa-arrow-left fa-lg icon-theme" aria-hidden="true"></i> Back to Bills</a></div>';
