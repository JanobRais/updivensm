...
if (UpdiveNSMConfig::get('graylog.server')) {
    echo '
    ...
    <script>
    ';
    $rowCount = UpdiveNSMConfig::get('graylog.device-page.rowCount', 10);
    $loglevel = UpdiveNSMConfig::get('graylog.device-page.loglevel', 7);
    $tmp_output .= '
        $.ajax({
            type: "post",
            data: {
