<?php
/*
 * UpdiveNSM module to Display data from F5 BigIP LTM Devices
 *
...
<div class="panel panel-default" id="pktsout">
    ...
    <script type="text/javascript">
        $("#grid").bootgrid({
            ...
            var link = '<?php echo \UpdiveNSM\Util\Url::generate($vars, ['type' => 'ltm_vs', 'subtype' => 'ltm_vs_det']); ?>vsid='+row['vsid']+'/poolid='+row['poolid'];
