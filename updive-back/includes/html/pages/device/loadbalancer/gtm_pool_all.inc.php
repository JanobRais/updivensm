<?php
/*
 * UpdiveNSM module to display F5 GTM Wide IP Details
 *
...
<div class="panel panel-default" id="dropped">
    ...
    <script type="text/javascript">
        $("#grid").bootgrid({
            ...
            var link = '<?php echo \UpdiveNSM\Util\Url::generate($vars, ['type' => 'gtm_pool', 'subtype' => 'gtm_pool_det']); ?>gtmpoolid='+row['gtmpoolid'];
