...
if ($vars['metric'] == 'overview') {
    foreach ($sensor_classes as $type) {
        ...
        include \App\Facades\UpdiveNSMConfig::get('install_dir') . '/includes/html/print-device-graph.php';
    }
    ...
    foreach ($sensors as $sensor) {
        ...
        include \App\Facades\UpdiveNSMConfig::get('install_dir') . '/includes/html/print-graphrow.inc.php';
