...
<script>
    ...
    $(function () {
        $("#dtpickerfrom").datetimepicker({
            ...
            defaultDate: '<?php echo Carbon::now()->subDay()->format(UpdiveNSMConfig::get('dateformat.byminute', 'Y-m-d H:i')); ?>'
        });
        ...
        if ($("#dtpickerto").val() != "") {
            ...
            $("#dtpickerto").data("DateTimePicker").maxDate('<?php echo Carbon::now()->format(UpdiveNSMConfig::get('dateformat.byminute', 'Y-m-d H:i')); ?>');
        }
    });
