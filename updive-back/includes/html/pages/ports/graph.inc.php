...
foreach ($ports as $port) {
    ...
    $type = \UpdiveNSM\Util\Rewrite::normalizeIfType($port['ifType']);

    $port['in_rate'] = \UpdiveNSM\Util\Number::formatSi($port['ifInOctets_rate'] * 8, 2, 0, 'bps');
    $port['out_rate'] = \UpdiveNSM\Util\Number::formatSi($port['ifOutOctets_rate'] * 8, 2, 0, 'bps');
