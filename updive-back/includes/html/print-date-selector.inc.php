<div style="text-align: center;">
    ...
    <script type="text/javascript">
        $(function () {
            var ds_datefrom = new Date(<?php echo \UpdiveNSM\Util\Time::parseAt($graph_array['from']); ?>*1000);
            var ds_dateto = new Date(<?php echo \UpdiveNSM\Util\Time::parseAt($graph_array['to']); ?>*1000);
