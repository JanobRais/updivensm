...
if ($vars['stream']) {
    $tmp_output .= '"<option value=\"' . \UpdiveNSM\Util\Clean::html($vars['stream'], []) . '\">' . \UpdiveNSM\Util\Clean::html($vars['stream'], []) . '</option>" +';
...
if (\App\Facades\UpdiveNSMConfig::has('graylog.timezone')) {
