 ...
 *
 * @copyright  2020 UpdiveNSM Contributors
...
if ($device['os'] == 'timos') {
    ...
    foreach ($bgpPeers ?? [] as $vrfOid => $vrf) {
        ...
        foreach ($vrf as $address => $value) {
            $astext = \UpdiveNSM\Util\AutonomousSystem::get($value['TIMETRA-BGP-MIB::tBgpPeerNgPeerAS4Byte'])->name();
