...
$scheduler = \App\Facades\UpdiveNSMConfig::get('schedule_type.alerting');
...
$alerts_lock = Cache::lock('alerts', \App\Facades\UpdiveNSMConfig::get('service_alerting_frequency'));
if ($alerts_lock->get()) {
    $alerts = new RunAlerts();
    if (! defined('TEST') && \App\Facades\UpdiveNSMConfig::get('alert.disable') != 'true') {
        echo 'Start: ' . date('r') . "\r\n";
