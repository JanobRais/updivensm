...
<template>
    <div v-tooltip="disabled ? $t('settings.readonly') : false">
        <div v-for="(data, group) in localList" class="tw:flex">
            ...
            >
            <UpdiveNSM-select class="form-control tw:grow" @change="updateRoles(group, $event)" route-name="ajax.select.role" :value="data.roles" multiple :disabled="disabled" :allow-clear="false"></UpdiveNSM-select>
        ...
        <div v-if="!disabled" class="tw:flex">
            ...
            <UpdiveNSM-select class="form-control tw:grow" v-model="newItemRoles" route-name="ajax.select.role" placeholder="Role" multiple :disabled="disabled" :allow-clear="false"></UpdiveNSM-select>
...
import UpdiveNSMSelect from "./UpdiveNSMSelect.vue";

export default {
        name: "SettingGroupRoleMap",
        components: {UpdiveNSMSelect},
        mixins: [BaseSetting],
        data() {
            return {
                newItem: "",
