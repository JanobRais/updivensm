<x-panel class="tw:rounded-lg tw:overflow-hidden">
    ...
    <x-slot name="footer" class="text-center">
        <div class="logon-message">{{ \App\Facades\UpdiveNSMConfig::get('login_message') }}</div>
    </x-slot>
    @endconfig
    ...
    <div class="container-fluid">
        ...
        @foreach (\App\Facades\UpdiveNSMConfig::get('auth.socialite.configs', []) as $provider => $config)
