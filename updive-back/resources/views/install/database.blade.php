                ...
                <div id="db-form-container" class="card-body collapse @if(!$valid_credentials) show @endif">
                    <form id="database-form" class="form-horizontal" role="form" method="post" action="{{ route('install.acton.test-database') }}">
                        ...
                        <div class="form-row pb-3">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="username" id="username" value="{{ $username ?? 'UpdiveNSM' }}">
                            </div>
                        </div>
                        <div class="form-row pb-3">
                        ...
                        <div class="form-row pb-3">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="database" id="database" value="{{ $database ?? 'UpdiveNSM' }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
