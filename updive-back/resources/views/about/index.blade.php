...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6">
            ...
            <h3>{{ __('UpdiveNSM is an autodiscovering PHP/MySQL-based network monitoring system') }}</h3>
            <table class='table table-condensed table-hover'>
                <tr>
                    <td><b>{{ __('Version') }}</b></td>
                    <td><a target="_blank" href='https://www.UpdiveNSM.org/changelog.html'>{{ $version_local }}<span id='version_date' style="display: none;">{{ $git_date }}</span></a></td>
                </tr>
                <tr>
          ...
          <h3>{{ __('UpdiveNSM is a community-based project') }}</h3>
          <p>
            {{ __('Please feel free to join us and contribute code, documentation, and bug reports:') }}
            <br />
            <a target="_blank" href="https://www.UpdiveNSM.org/">{{ __('Web site') }}</a> |
            <a target="_blank" href="https://docs.UpdiveNSM.org/">{{ __('Docs') }}</a> |
            <a target="_blank" href="https://github.com/UpdiveNSM/">{{ __('GitHub') }}</a> |
            <a target="_blank" href="https://community.UpdiveNSM.org/c/help">{{ __('Bug tracker') }}</a> |
            <a target="_blank" href="https://www.UpdiveNSM.org/shop">{{ __('Merch Shop') }}</a> |
            <a target="_blank" href="https://community.UpdiveNSM.org">{{ __('Community Forum') }}</a> |
            <a target="_blank" href="https://twitter.com/UpdiveNSM">{{ __('Twitter') }}</a> |
            <a target="_blank" href="https://www.linkedin.com/company/UpdiveNSM">{{ __('LinkedIn') }}</a> |
            <a target="_blank" href="https://www.UpdiveNSM.org/changelog.html">{{ __('Changelog') }}</a> |
            <a href="#" data-toggle="modal" data-target="#git_log">{{ __('Local git log') }}</a>
          </p>

          <h3>{{ __('Contributors') }}</h3>

          <p>{!! __('See the <a target="_blank" href=":url">list of contributors</a> on GitHub.', ['url' => 'https://github.com/UpdiveNSM/UpdiveNSM/graphs/contributors']) !!}</p>
      ...
      <div class="col-md-6">
        ...
        <table class='table table-condensed'>
            ...
            <tr>
                <td colspan='4'>
                    <div>
                        <label for="reporting.usage" class="bg-info">{{ __('Opt in to send anonymous reports to UpdiveNSM?') }}</label>
                    </div>
                    <div>
                    ...
                    <div class="tw:mt-2">
                    {{ __('Usage statistics:') }} <input type="checkbox" id="reporting.usage" name="reporting" data-size="small" @if($usage_reporting_status) checked @endif> <a target="_blank" href='https://stats.UpdiveNSM.org/'>stats.UpdiveNSM.org</a>
                    </div>
