...
@php
    ...
    $config['engine'] ??= \App\Facades\UpdiveNSMConfig::get('geoloc.engine');
    $config['api_key'] ??= \App\Facades\UpdiveNSMConfig::get('geoloc.api_key');
    $config['tile_url'] ??= \App\Facades\UpdiveNSMConfig::get('leaflet.tile_url', '{s}.tile.openstreetmap.org');
@endphp
