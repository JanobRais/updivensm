        ...
        Alpine.data('dateRangePicker', () => ({
            ...
            get start() {
                if (this.relativeStartSeconds !== null) {
                    return UpdiveNSM.Date.now().minus({ seconds: this.relativeStartSeconds });
                }

                if (this.startDate) {
                    return UpdiveNSM.Date.parse(this.startTime ? `${this.startDate}T${this.startTime}` : `${this.startDate}T00:00`);
                }
            ...
            get end() {
                ...
                if (!this.endTime) {
                    ...
                    return UpdiveNSM.Date.parse(`${this.endDate}T23:59:59`);
                }

                return UpdiveNSM.Date.parse(`${this.endDate}T${this.endTime}`);
            },
            ...
            get outStartString() {
                ...
                return UpdiveNSM.Date.toUrl(this.start);
            },
            ...
            get outEndString() {
                ...
                return UpdiveNSM.Date.toUrl(this.end);
            },
            ...
            parseDateTime(dateInput) {
                ...
                const dt = UpdiveNSM.Date.parse(input);
                ...
                const pickerString = UpdiveNSM.Date.toPicker(dt);
            ...
            formatDate(dt, timeString) {
                ...
                return UpdiveNSM.Date.display(dt, opts);
            },
