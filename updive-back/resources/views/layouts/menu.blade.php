                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu multi-level" role="menu">
                        <li class="dropdown-submenu">
                            <a href="{{ route('overview') }}"><i class="fa fa-tv fa-fw fa-lg" aria-hidden="true"></i> {{ __('dashboard.labels.dashboard') }}</a>
                        ...
                        <li class="dropdown-submenu">
                            <a><i class="fa fa-plug fa-fw fa-lg" aria-hidden="true"></i> {{ __('plugins.admin_title') }}</a>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{ \App\Facades\UpdiveNSMConfig::get('smokeping.url') }}"><i class="fa fa-line-chart fa-fw fa-lg"
                        ...
                        <li><a href="{{ route('inventory') }}"><i class="fa fa-cube fa-fw fa-lg"
                                                                 aria-hidden="true"></i> {{ __('inventory.all_parts') }}</a></li>
                        @if($package_count)
                ...
                <li class="dropdown">
                    <a href="{{ url('services') }}" class="dropdown-toggle" data-hover="dropdown"
                       data-toggle="dropdown"><i class="fa fa-map fa-fw fa-lg fa-nav-icons"
                                                 aria-hidden="true"></i> <span
                            class="tw:md:hidden tw:lg:inline-block">{{ __('map.title') ?? 'Maps ' }}</span></a>
                    <ul class="dropdown-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('viewAny', \App\Models\Port::class)
                            @if($port_groups_exist)
                                ...
                                @endconfig
                                @if(\App\Facades\UpdiveNSMConfig::get('int_peering') && \App\Facades\UpdiveNSMConfig::get('int_transit'))
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="https://docs.UpdiveNSM.org/API/" target="_blank" rel="noopener"><i
