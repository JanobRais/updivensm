...
<div class="container">
    ...
    <hr class="separator"/>
    <p>{{ __("Check your log for more details.") }} ({{ isset($log_file) ? $log_file : 'UpdiveNSM.log' }})</p>

    <p>{{ __("If you need additional help, you can find how to get help at") }} <a target="_blank" href="https://docs.UpdiveNSM.org/Support">https://docs.UpdiveNSM.org/Support</a>.</p>
