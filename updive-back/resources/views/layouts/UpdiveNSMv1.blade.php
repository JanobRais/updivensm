...
<head>
    ...
    <base href="{{ UpdiveNSMConfig::get('base_url') }}">
    <meta http-equiv="content-type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    @if(!UpdiveNSMConfig::get('favicon', false))
    ...
    @else
        <link rel="shortcut icon" href="{{ UpdiveNSMConfig::get('favicon') }}">
    @endif
    ...
    <link href="{{ asset(UpdiveNSMConfig::get('stylesheet', 'css/styles.css')) }}?ver=02132026" rel="stylesheet">
    ...
    @endif
    @foreach(UpdiveNSMConfig::get('webui.custom_css', []) as $custom_css)
    ...
    <script src="{{ asset('js/UpdiveNSM.js?ver=02032026') }}"></script>
