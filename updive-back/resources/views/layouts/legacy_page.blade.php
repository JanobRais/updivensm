        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h5>Powered by <a href="{{ \App\Facades\UpdiveNSMConfig::get('project_home') }}" target="_blank" rel="noopener" class="red">{{ \App\Facades\UpdiveNSMConfig::get('project_name') }}</a>.</h5>
                </div>
            </div>
        </div>
    </nav>
