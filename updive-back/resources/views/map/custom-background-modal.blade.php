    ...
    function backgroundModalData() {
        return {
            ...
            resetBackground() {
                ...
                this.color = 'color' in this.initial_data ? this.initial_data.color : '{{ UpdiveNSMConfig::get('custom_map.background_data.color') }}';
                this.lat = 'lat' in this.initial_data ? this.initial_data.lat : {{ (float) UpdiveNSMConfig::get('custom_map.background_data.lat') }};
                this.lng = 'lng' in this.initial_data ? this.initial_data.lng : {{ (float) UpdiveNSMConfig::get('custom_map.background_data.lng') }};
                this.zoom = 'zoom' in this.initial_data ? this.initial_data.zoom : {{ (int) UpdiveNSMConfig::get('custom_map.background_data.zoom') }};
                this.layer = 'layer' in this.initial_data ? this.initial_data.layer :  {{ Js::from(UpdiveNSMConfig::get('custom_map.background_data.layer')) }};
