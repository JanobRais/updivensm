...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="UpdiveNSM Service - manages polling and other periodic processes"
    )
    parser.add_argument(
        "-g",
        "--group",
    ...
    parser.add_argument(
        ...
        const="file",
        default="none",
        type=UpdiveNSM.LogOutput,
        choices=list(UpdiveNSM.LogOutput),
        metavar="DEST",
        help=(
    ...
    info("Configuring UpdiveNSM service")
    try:
        service = UpdiveNSM.Service()
    ...
    info(
        "Entering main UpdiveNSM service loop on {}/{}...".format(
