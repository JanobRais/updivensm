 ...
 */
 ...
 return [
     ...
     |--------------------------------------------------------------------------
     |
     | This value is the user UpdiveNSM runs as. It is used to secure permissions
     ...
     */
     ...
     |--------------------------------------------------------------------------
     |
     | This value is the group UpdiveNSM runs as. It is used to secure permissions
     | and grant access to things needed. Defaults to the same as UpdiveNSM_USER.
     */

     'group' => env('UpdiveNSM_GROUP', env('UpdiveNSM_USER', 'UpdiveNSM')),
