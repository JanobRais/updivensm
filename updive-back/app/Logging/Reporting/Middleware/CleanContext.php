    ...
    public function handle(Report $report, \Closure $next)
    {
        try {
            ...
            if (isset($context['request']['url'])) {
                $context['request']['url'] = str_replace($context['headers']['host'] ?? '', 'UpdiveNSM', $context['request']['url']);
            }

            if (isset($context['session']['url']['intended'])) {
                $context['session']['url']['intended'] = str_replace($context['headers']['host'] ?? '', 'UpdiveNSM', $context['session']['url']['intended']);
            }

            if (isset($context['session']['_previous']['url'])) {
                $context['session']['_previous']['url'] = str_replace($context['headers']['host'] ?? '', 'UpdiveNSM', $context['session']['_previous']['url']);
            }
