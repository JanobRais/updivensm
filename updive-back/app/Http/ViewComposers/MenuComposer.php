 ...
 * Menu.php
 *
 * Builds data for UpdiveNSM menu
 *
...
use UpdiveNSM\Interfaces\Plugins\Hooks\MenuEntryHook;
use UpdiveNSM\Plugins;
use UpdiveNSM\Util\ObjectCache;
use PluginManager;
...
class MenuComposer
{
    ...
    public function compose(View $view)
    {
        ...
        $vars['project_name'] = UpdiveNSMConfig::get('project_name', 'UpdiveNSM');
        ...
        $configDeviceTypes = Arr::keyBy(UpdiveNSMConfig::get('device_types'), 'type');
        ...
        $vars['locations'] = (UpdiveNSMConfig::get('show_locations') && UpdiveNSMConfig::get('show_locations_dropdown')) ?
        ...
        // Service menu
        if (UpdiveNSMConfig::get('show_services')) {
        ...
        $vars['port_counts']['pseudowire'] = UpdiveNSMConfig::get('enable_pseudowires') ? ObjectCache::portCounts(['pseudowire'])['pseudowire'] : 0;

        $vars['port_counts']['alerted'] = 0; // not actually supported on old...

        $custom_descr = [];
        foreach ((array) UpdiveNSMConfig::get('custom_descr', []) as $descr) {
        ...
        $vars['port_groups_exist'] = UpdiveNSMConfig::get('int_customers') ||
            UpdiveNSMConfig::get('int_transit') ||
            UpdiveNSMConfig::get('int_peering') ||
            UpdiveNSMConfig::get('int_core') ||
            UpdiveNSMConfig::get('int_l2tp') ||
        ...
        if (Gate::any(['routing.view', 'routing.viewAll', 'routing.update'])) {
            ...
            if ($routing_count['bgp']) {
                $vars['show_peeringdb'] = UpdiveNSMConfig::get('peeringdb.enabled', false);
        ...
        // Search bar
        $vars['typeahead_limit'] = UpdiveNSMConfig::get('webui.global_search_result_limit');
