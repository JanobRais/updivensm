 ...
 * CheckInstalled.php
 *
 * Check if UpdiveNSM install has been completed (config.php exists) and redirect to install.php as needed.
 *
...
class CheckInstalled
{
    ...
    {
        $installed = ! config('UpdiveNSM.install') && file_exists(base_path('.env'));
