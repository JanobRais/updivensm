...
class AboutController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('about.index', [
            'usage_reporting_status' => UpdiveNSMConfig::get('reporting.usage'),
            'error_reporting_status' => UpdiveNSMConfig::get('reporting.error'),
            ...
            'project_name' => UpdiveNSMConfig::get('project_name'),
            ...
            'version_netsnmp' => str_replace('version: ', '', rtrim(shell_exec(UpdiveNSMConfig::get('snmpget', 'snmpget') . ' -V 2>&1'))),
    ...
    public function clearReportingData(): JsonResponse
    {
        ...
        if ($usage_uuid) {
            if (! Http::client()->post(UpdiveNSMConfig::get('callback_clear'), ['uuid' => $usage_uuid])->successful()) {
