...
class SslCertificateController extends Controller
{
    ...
    public function show(SslCertificate $ssl_certificate)
    {
        ...
        $options = [
            'days_until_expiry_warning' => (int) UpdiveNSMConfig::get('ssl_certificates.days_until_expiry_warning', 30),
            'days_until_expiry_danger' => (int) UpdiveNSMConfig::get('ssl_certificates.days_until_expiry_danger', 0),
        ];
