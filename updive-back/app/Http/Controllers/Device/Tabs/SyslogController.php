...
class SyslogController extends Controller
{
    public function __invoke(Device $device, Request $request): View
    {
        ...
        return view('device.tabs.logs.syslog', [
            'device' => $device,
            'filter_device' => false,
            'now' => Carbon::now()->format(UpdiveNSMConfig::get('dateformat.byminute', 'Y-m-d H:i')),
            'default_date' => Carbon::now()->subDay()->format(UpdiveNSMConfig::get('dateformat.byminute', 'Y-m-d H:i')),
