...
class PortsController implements DeviceTab
{
    ...
    private function portData(Device $device, Request $request): array
    {
        ...
        if ($this->detail) {
            ...
            if (UpdiveNSMConfig::get('ports_ipv4_neighbours') == 'arp') {
    ...
    private function parseTab(Request $request): string
    {
        ...
        return $request->route('vars', UpdiveNSMConfig::get('ports_page_default')); // fourth segment is called vars to handle legacy urls
    }
