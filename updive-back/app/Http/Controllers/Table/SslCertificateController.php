...
class SslCertificateController extends TableController
{
    ...
    public function formatItem($model)
    {
        ...
        $daysWarning = (int) UpdiveNSMConfig::get('ssl_certificates.days_until_expiry_warning', 30);
        $daysDanger = (int) UpdiveNSMConfig::get('ssl_certificates.days_until_expiry_danger', 0);
        $deviceLink = null;
