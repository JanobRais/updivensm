...
class GlobeController extends WidgetController
{
    ...
    public function __construct()
    {
        ...
        $this->defaults = [
            'title' => null,
            'markers' => UpdiveNSMConfig::get('frontpage_globe.markers', 'devices'),
            'region' => UpdiveNSMConfig::get('frontpage_globe.region', 'world'),
            'resolution' => UpdiveNSMConfig::get('frontpage_globe.resolution', 'countries'),
            'device_group' => null,
        ];
    }
