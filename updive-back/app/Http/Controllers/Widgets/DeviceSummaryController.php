...
abstract class DeviceSummaryController extends WidgetController
{
    ...
    public function __construct()
    {
        ...
        $this->defaults = [
            'show_services' => (int) UpdiveNSMConfig::get('show_services', 1),
            'show_sensors' => (int) UpdiveNSMConfig::get('show_sensors', 1),
            'summary_errors' => (int) UpdiveNSMConfig::get('summary_errors', 0),
        ];
    }
