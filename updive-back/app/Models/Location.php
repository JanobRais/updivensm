...
class Location extends Model
{
    ...
    public function lookupCoordinates($hostname = null)
    {
        ...
        if ($hostname && \App\Facades\UpdiveNSMConfig::get('geoloc.dns')) {
        ...
        if ($this->location && ! $this->hasCoordinates() && \App\Facades\UpdiveNSMConfig::get('geoloc.latlng', true)) {
    ...
    {
        try {
            /** @var \UpdiveNSM\Interfaces\Geocoder $api */
            $api = app(\UpdiveNSM\Interfaces\Geocoder::class);
