...
class Device extends BaseModel
{
    ...
    public function displayName(): string
    {
        ...
        return SimpleTemplate::parse($this->display ?: \App\Facades\UpdiveNSMConfig::get('device_display_default', '{{ $hostname }}'), [
    ...
    public function shortDisplayName($length = 12)
    {
        ...
        $length = \App\Facades\UpdiveNSMConfig::get('shorthost_target_length', $length);
