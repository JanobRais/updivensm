...
class Checks
{
    ...
    public static function postAuth()
    {
        ...
        Cache::put('checks_popup_timeout', true, UpdiveNSMConfig::get('checks_popup_timer', 5) * 60);
        ...
        if (Gate::allows('notification.update')) { // FIXME correct permission check?
            ...
            $warn_sec = UpdiveNSMConfig::get('rrd.step', 300) * 3;
            ...
            $temp_dir = UpdiveNSMConfig::get('temp_dir');
            if (! is_dir($temp_dir)) {
