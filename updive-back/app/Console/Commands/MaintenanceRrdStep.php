...
class MaintenanceRrdStep extends LnmsCommand
{
    ...
    {
        $systemStep = (int) UpdiveNSMConfig::get('rrd.step', 300);
        $icmpStep = (int) UpdiveNSMConfig::get('ping_rrd_step', $systemStep);
        $systemHeartbeat = (int) UpdiveNSMConfig::get('rrd.heartbeat', $systemStep * 2);
    ...
    {
        $rrd_dir = UpdiveNSMConfig::get('rrdcached')
            ? '/'
            : UpdiveNSMConfig::get('rrd_dir', UpdiveNSMConfig::get('install_dir') . '/rrd');
