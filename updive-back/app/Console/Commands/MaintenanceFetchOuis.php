...
class MaintenanceFetchOuis extends LnmsCommand
{
    ...
    public function handle(): int
    {
        ...
        if (UpdiveNSMConfig::get('mac_oui.enabled') !== true && ! $force) {
            ...
            UpdiveNSMConfig::persist('mac_oui.enabled', true);
        }
        ...
        try {
            ...
            $csv_data = \UpdiveNSM\Util\Http::client()->get($this->mac_oui_url)->body();
