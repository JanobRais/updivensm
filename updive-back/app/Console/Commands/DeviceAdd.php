...
class DeviceAdd extends LnmsCommand
{
    ...
    public function __construct()
    {
        ...
        $this->optionValues = [
            ...
            'auth-protocol' => \UpdiveNSM\SNMPCapabilities::supportedAuthAlgorithms(...),
            'privacy-protocol' => \UpdiveNSM\SNMPCapabilities::supportedCryptoAlgorithms(...),
        ];

        $this->optionDefaults = [
            'port' => fn () => UpdiveNSMConfig::get('snmp.port', 161),
            'transport' => fn () => UpdiveNSMConfig::get('snmp.transports.0', 'udp'),
            'poller-group' => fn () => UpdiveNSMConfig::get('default_poller_group'),
            'port-association-mode' => fn () => UpdiveNSMConfig::get('default_port_association_mode'),
