...
use UpdiveNSM\Validations\Database\CheckDatabaseConnected;
use UpdiveNSM\Validations\Poller\CheckRedis;
    ...
    public function handle(): int
    {
        ...
        if (EnvHelper::UpdiveNSMDocker()) {
            if (getenv('SIDECAR_DISPATCHER')) {
                // check dispatcher
                $health_file = \App\Facades\UpdiveNSMConfig::get('service_health_file');
