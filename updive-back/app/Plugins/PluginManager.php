...
use UpdiveNSM\Interfaces\Plugins\PluginManagerInterface;
...
class PluginManager implements PluginManagerInterface
{
    ...
    /**
     * Publish plugin hook, this is the main way to hook into different parts of UpdiveNSM.
        ...
        return $this->hooksFor($hookType, $args, $plugin)
            ->map(function ($hook) use ($args, $hookType) {
                try {
                    ...
                    if (\App\Facades\UpdiveNSMConfig::get('plugins.show_errors')) {
                        throw $e;
                    }
